...
int main()
{
    ...
    while (true)
    {
        ...
        cout << "24 : Get the winner prize of each cuisine " << endl;
        ...
        if (choice == 1)
        {
            ...
            restaurant.insertIntoFileBST(state, nameRestaurant, numEmp);
            resto.NameR = nameRestaurant;
            tree.InsertRes(resto);
            t.insertResTree(tree);
        }
        else if (choice == 2)
        {
            cout << "Give the name of the restaurant you want to add: ";
            ...
            restaurant.removeRestaurant(nameRestaurant);
        }
        else if (choice == 3)
        {
        ...
        else if (choice == 4)
        {
            ...
            string name;
            getline(cin, name);
            restaurant.modifyrestaurant(name);
        }
        else if (choice == 5)
        {
        ...
        else if (choice == 7)
        {
            ...
            if (country.doesExistDistrict(nameWilaya, nameCity, nameDistrict))
            {
                ...
                {
                    const wilaya::RestauNode* restoList = country.getDistrictRestaurants(nameWilaya, nameCity, nameDistrict);
        ...
        else if (choice == 8)
        {
            ...
            {
                vector<wilaya::arrayCaseRList> districts = country.getCityRestaurants(nameWilaya, nameCity);
        ...
        else if (choice == 9)
        {
            ...
            {
                vector<wilaya::arrayCase1To2> cities = country.getWilayaRestaurants(nameWilaya);
                cout << "Wilaya: " << nameWilaya << endl;
